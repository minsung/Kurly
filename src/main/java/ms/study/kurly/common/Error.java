...
public enum Error {
    ...
    VERIFICATION_TOKEN_NOT_FOUND(1005, "잘못된 요청입니다.", "인증 토큰 누락", HttpStatus.BAD_REQUEST),
    VERIFICATION_TOKEN_NOT_MATCH(1006, "잘못된 요청입니다.", "인증 토큰 불일치", HttpStatus.BAD_REQUEST),
